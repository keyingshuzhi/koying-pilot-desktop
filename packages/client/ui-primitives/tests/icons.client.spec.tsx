...
describe('FishLogo', () => {
  it('renders the fish path in currentColor at the native ratio', () => {
    ...
    expect(svg.dataset.dshBrandSymbol).toBe('default')
...
describe('BrandWordmark', () => {
  it('exposes the stable product-brand replacement hook', () => {
    const { container } = render(<primitives.BrandWordmark />)
    expect(container.querySelector('svg')?.dataset.dshBrandWordmark).toBe('default')
  })
})
