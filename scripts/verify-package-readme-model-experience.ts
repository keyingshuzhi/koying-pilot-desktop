...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-about': { kind: 'none', reason: 'the browser-only attribution page adds no model context.' },
  ...
  'packages/bundle/desktop': { kind: 'none', reason: 'The patch-list carrier adds only a browser-side product-information page.' },
